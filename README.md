...
(Done following the tutorial in Jonas Schmidttmann react course on Udemy).
...
First full functional page I've done in React. I learned how to deal with states (when and where to use states, derived states, states up-lifting, local and total states). Also learned how to empty or sort the list, how immutability works in React and where and when to use props. 
